      ...
      equation
       when clockValue >  bound and conditionPort then
        ...
        annotation (
          ...
          Documentation(info="<!DOCTYPE html>
<html>
<head><title>RealTimeCoordinationLibrary.RealTimeCoordination.TimeElements.TimeInvariantLessOrEqual</title></head>
<body>
<p>
The (time varying) Real output signal of this block can be defined in its
parameter menu via variable <b>y</b>. The purpose is to support the
      ...
      equation
       when clockValue >=  bound and conditionPort then
        ...
        annotation (
          ...
          Documentation(info="<!DOCTYPE html>
<html>
<head><title>RealTimeCoordinationLibrary.RealTimeCoordination.TimeElements.TimeInvariantLess</title></head>
<body>
<p>
The (time varying) Real output signal of this block can be defined in its
parameter menu via variable <b>y</b>. The purpose is to support the
